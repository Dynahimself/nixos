...
in
{
  ...
  # War casualties
  home.file.".gtkrc-2.0" = lib.mkForce {
    force = true;
    # Note: If you mkForce the whole attribute, you might lose the content
    # generated by the GTK module. The standard merge above is preferred.
  };
